        ...
        <div class="row block-9">
          <div class="col-md-6 order-md-last d-flex">
			...
			<h6 align="center">sign up </h6>
              ...
              <div class="form-group">
                <input type="text" name="conno" class="form-control" placeholder="contectno">
              </div>
              <div class="form-group">
                <textarea name="text" id=""  name="meg" cols="30" rows="7" class="form-control"  placeholder="message"></textarea>
              </div>
              <div class="form-group">
...
<?php
    if(isset($_POST['submit']))
	{
		...
		$qry="insert into contact(yourname ,youremail,contactno,message)values('$name','$email','$conno','$meg')";	
